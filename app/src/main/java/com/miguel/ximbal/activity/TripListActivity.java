...
import com.miguel.ximbal.trips.TripListAdapter;
...
import static com.miguel.ximbal.activity.ConfirmDialog.createDialog;
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.itemDelete:
                onCreateDialog(ConfirmDialog.DIALOG_CONFIRM_DELETE_ID);
                return true;
